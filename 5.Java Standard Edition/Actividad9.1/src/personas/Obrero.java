...
public class Obrero extends Empleado {
	...
	public Obrero(String nombre, byte edad, char sexo, String dni, boolean bCasado,String idPersonal, float sueldo,char turno, byte trienio) throws PersonalNumberException{
