...
public class CuentaAccesos extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		synchronized(context){
			numeroAccesos++;
			nAccesos=numeroAccesos;
		}
		request.setAttribute("numeroAccesosServlet",nAccesos);
	...
	/**
	 * Incrementa la cuenta de accesos de la sesion
	 * 
	 * @param sesion objeto sesion HttpSession
