...
<body>
	<sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver"
		url="jdbc:mysql://localhost:3306/cursojdbc" user="actividades"
		password="zsexdr" />
	<sql:update dataSource="${snapshot}" var="count">
 UPDATE producto SET nombre = 'Nombre Actualizado' 
 WHERE idproducto = ?
...
SELECT * FROM producto
	...
	<div>
		<c:if test="${idproducto == null}">
			<h3>No se ha actualizado a ningún producto, no se ha insertado a
